...
file_path_excel = '../data-files/berdo_data_files/berdo_building_summary_statistics-acp-2025.xlsx'
...
fines_2025_2030 = calculate_fines(df_berdo, df_emissions_factors, 2025, 2029)
fines_2030_2034 = calculate_fines(df_berdo, df_emissions_factors, 2030, 2034)
fines_2035_2039 = calculate_fines(df_berdo, df_emissions_factors, 2035, 2039)
fines_2040_2044 = calculate_fines(df_berdo, df_emissions_factors, 2040, 2044)
fines_2045_2049 = calculate_fines(df_berdo, df_emissions_factors, 2045, 2049)
...
building_type_summary_df = pd.merge(df_building_type_summary, aggregated_fines_2025_2029,
                                    on='BERDO Property Type', how='left', suffixes=('', '_2025_2039'))
...
building_type_summary_df = pd.merge(building_type_summary_df, aggregated_fines_2030_2034,
                                    on='BERDO Property Type', how='left', suffixes=('', '_2030_2034'))
...
building_type_summary_df = pd.merge(building_type_summary_df, aggregated_fines_2035_2039,
                                    on='BERDO Property Type', how='left', suffixes=('', '_2035_2039'))
...
building_type_summary_df = pd.merge(building_type_summary_df, aggregated_fines_2040_2044,
                                    on='BERDO Property Type', how='left', suffixes=('', '_2040_2044'))
...
building_type_summary_df = pd.merge(building_type_summary_df, aggregated_fines_2045_2049,
                                    on='BERDO Property Type', how='left', suffixes=('', '_2045_2049'))
